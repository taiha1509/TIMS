...
<script lang="ts">
import { initData, initValues } from '../../composition/assetForm';
...
export default class AssetFormPopup extends UtilMixins {
    ...
    get maxPurchaseDate(): string | null {
        return moment().add(1, 'days').fmDayString();
    }
